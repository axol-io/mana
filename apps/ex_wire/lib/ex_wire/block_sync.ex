defmodule ExWire.BlockSync do
  @moduledoc """
  Block synchronization implementation using standard GenServer patterns.
  Handles downloading and processing of blockchain blocks from peers.
  """
  ...
  @impl true
  def handle_call(:get_sync_status, _from, _state) do
    status = %{
  ...
  @impl true
  def handle_call({:sync_blocks, start_block, end_block}, _from, _state) do
  ...
  @impl true
  def handle_call(:get_sync_progress, _from, _state) do
    progress = calculate_progress(state)
    {:reply, progress, state}
  end

  @impl true
  def handle_cast({:add_peer, peer_info}, _state) do
  ...
  @impl true
  def handle_info({:process_blocks, start_block, end_block}, _state) do
  ...
  defp determine_sync_status(_state) do
    cond do
