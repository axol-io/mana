defmodule ExWire.DVT.Crypto do
  ...
  def load_nif do
    nif_file = :filename.join(:code.priv_dir(:ex_wire), ~c"native/libdvt_crypto")
  ...
  def aggregate_signature_shares(_public_key_set, _shares, _threshold),
    do: :erlang.nif_error(:nif_not_loaded)

  def verify_threshold_signature(_public_key, _signature, _message),
    do: :erlang.nif_error(:nif_not_loaded)

  def verify_signature_share(_public_key_set, _share_data, _message),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  # DKG NIFs
  def initialize_dkg_round(_node_id, _participants, _threshold, _round_id),
    do: :erlang.nif_error(:nif_not_loaded)

  def process_dkg_share(_participant, _share_data), do: :erlang.nif_error(:nif_not_loaded)

  def finalize_dkg_round(_participant, _expected_participants, _threshold),
    do: :erlang.nif_error(:nif_not_loaded)

  def verify_dkg_result(_result, _threshold, _participants),
    do: :erlang.nif_error(:nif_not_loaded)

  def generate_dkg_complaint(_complainer, _accused, _share, _round_id),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  ## Returns
  {:ok, {public_key_set, key_shares}} | {:error, _reason}
  """
  ...
  ## Returns
  {:ok, signature_share} | {:error, _reason}
  """
  ...
  ## Returns
  {:ok, threshold_signature} | {:error, _reason}
  """
  ...
  ## Returns
  {:ok, {dkg_participant, initial_shares}} | {:error, _reason}
  """
  ...
  ## Returns
  {:ok, updated_participant} | {:error, _reason}
  """
  ...
  ## Returns
  {:ok, complaint_data} | {:error, _reason}
  """
