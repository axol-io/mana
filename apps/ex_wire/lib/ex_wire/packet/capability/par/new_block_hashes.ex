defmodule ExWire.Packet.Capability.Par.NewBlockHashes do
  @moduledoc """
  ...
  **NewBlockHashes** [`+0x01`: `P`, [`hash_0`: `B_32`, `number_0`: `P`], [`hash_1`: `B_32`, `number_1`: `P`], ...]
  ...
  ## Examples
      ...
      iex> %ExWire.Packet.Capability.Par.NewBlockHashes{hashes: [{<<5>>, 1}, {<<6>>, 2}]}
      ...> |> ExWire.Packet.Capability.Par.NewBlockHashes.serialize()
      [[<<5>>, 1], [<<6>>, 2]]

      iex> %ExWire.Packet.Capability.Par.NewBlockHashes{hashes: []}
      ...> |> ExWire.Packet.Capability.Par.NewBlockHashes.serialize()
      []
  """
  @impl true
  ...
  ## Examples
      ...
      iex> ExWire.Packet.Capability.Par.NewBlockHashes.deserialize([[<<5>>, 1], [<<6>>, 2]])
      %ExWire.Packet.Capability.Par.NewBlockHashes{hashes: [{<<5>>, 1}, {<<6>>, 2}]}

      iex> ExWire.Packet.Capability.Par.NewBlockHashes.deserialize([])
  ...
  ## Examples
      ...
      iex> %ExWire.Packet.Capability.Par.NewBlockHashes{hashes: [{<<5>>, 1}, {<<6>>, 2}]}
      ...> |> ExWire.Packet.Capability.Par.NewBlockHashes.handle()
      :ok
  """
  @impl true
