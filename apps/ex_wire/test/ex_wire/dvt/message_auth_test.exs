defmodule ExWire.DVT.MessageAuthTest do
  ...
  describe "message creation" do
    test "creates authenticated message with valid parameters" do
      ...
      assert {:ok, message} =
               MessageAuth.create_authenticated_message(
                 @cluster_id,
                 :duty_consensus,
                 payload,
                 @test_private_key,
  ...
  describe "message verification" do
    ...
    test "rejects message with invalid signature" do
      ...
      assert {:error, :invalid_signature} =
               MessageAuth.verify_authenticated_message(tampered_message)
    end
    ...
    test "rejects message with missing required fields" do
      ...
      assert {:error, :invalid_structure} =
               MessageAuth.verify_authenticated_message(incomplete_message)
    end
    ...
    test "rejects expired message" do
      ...
      # 400 seconds ago
      old_timestamp = DateTime.add(DateTime.utc_now(), -400, :second)
